...
# Per-chunk budget: large materials (50+ chunks) can exceed the flat deadline
# since Zep processes episodes sequentially (~10-15s each).
ZEP_INGESTION_PER_CHUNK_WAIT_SECONDS = 20
