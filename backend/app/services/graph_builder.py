...
from ..utils.zep import (
    ZEP_INGESTION_PER_CHUNK_WAIT_SECONDS,
...
class GraphBuilderService:
    ...
    def create_graph(
        ...
        *,
        ...
        graph_id = graph_id or f"prism_{uuid.uuid4().hex[:16]}"
        ...
        try:
            self.client.graph.create(
                graph_id=graph_id,
                name=name,
                description="PRISM Social Simulation Graph"
            )
        ...
        for attempt in range(1, max_attempts + 1):
            ...
            while True:
                ...
                for batch in getattr(page, "batches", None) or []:
                    ...
                    if (
                        metadata.get("prism_operation_id") == operation_id
    ...
    def add_text_batches(
        ...
        try:
            batch = self.client.batch.create(
                metadata={
                    "prism_operation_id": operation_id,
                    "graph_id": graph_id,
        ...
        for i in range(0, total_chunks, batch_size):
            ...
            items = [
                BatchAddItem(
                    ...
                    data=chunk,
                    data_type="text",
                    source_description="PRISM source document chunk",
                    metadata={
                        "prism_operation_id": operation_id,
    ...
    def _wait_for_batch(
        ...
        timeout = timeout or max(
            ZEP_INGESTION_WAIT_TIMEOUT_SECONDS,
            submission.item_count * ZEP_INGESTION_PER_CHUNK_WAIT_SECONDS,
        )
