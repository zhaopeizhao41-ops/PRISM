...
class Project:
    ...
    # 推演宇宙独立图谱（与真实传记图谱物理隔离，防止平行宇宙"事实"污染人格卡）
    evolution_graph_id: Optional[str] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "evolution_graph_id": self.evolution_graph_id,
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'Project':
        ...
        return cls(
            ...
            evolution_graph_id=data.get('evolution_graph_id'),
